...
public class Version {
    ...
    private Version() {
        try {
            ...
            p.load(in);
            value=p.getProperty("com.ontology2.birthdayMachine.version");
            if(value==null)
                log.error("version properties file did not contain a com.ontology2.birthdayMachine.version property");
